class Api::V1::BooksController < ApplicationController
    ...
    def base
        ...
        #@books.concat(RakutenWebService::Books::Book.search(title: "入門 Python", booksGenreId: "001005017", page: page, hits: 1).to_a)
        ...
        #@books.concat(RakutenWebService::Books::Book.search(title: "入門 AWS", booksGenreId: "001005017", page: page, hits: 1).to_a)
